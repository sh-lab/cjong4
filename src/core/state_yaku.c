...
cj4_yaku_find_tile_wall_index(
    ...
    cj4_tile_id tile)
{
    return state->locations[tile].wall;
}
    ...
    cj4_yaku_context *ctx)
{
    ...
    if (cj4_state_phase(state) == CJ4_PHASE_DRAW &&
        cj4_state_current_player(state) == player &&
        state->draw_tile != CJ4_TILE_ID_INVALID &&
        cj4_state_tile_is_in_hand(state, player, state->draw_tile))
    {
        uint8_t wall_index;
        ...
        state->discard_count > 0)
    {
        ...
        if (last != CJ4_TILE_ID_INVALID &&
            cj4_state_tile_is_in_hand(state, player, last))
        {
    ...
    if ((cj4_state_phase(state) == CJ4_PHASE_KAKAN_RESOLVE ||
        ...
        cj4_state_is_chankan(state) &&
        player != cj4_state_current_player(state))
    {
        cj4_tile_id tile = cj4_state_phase(state) == CJ4_PHASE_KAKAN_RESOLVE
    ...
    cj4_yaku_flags *flags)
{
    ...
    if (cj4_state_double_riichi(state, player))
        *flags |= CJ4_YAKU_DOUBLE_RIICHI;

    if (rules && rules->ippatsu && cj4_state_is_ippatsu(state, player))
...
cj4_yaku_is_winner(
    ...
    cj4_player player)
{
    return (uint8_t)cj4_state_is_winner(state, player);
}
...
static void
cj4_yaku_copy_indicator_tiles(
    const cj4_mahjong *state,
    uint8_t riichi_only,
    cj4_tile_id out_tiles[CJ4_MAX_WIN_RESULT_DORA_INDICATORS],
    uint8_t *out_count)
{
...
static uint8_t
cj4_yaku_collect_best_result(
    const cj4_mahjong *state,
    cj4_player player,
    const cj4_rules *rules,
    cj4_yaku_best_score *out)
{
    cj4_yaku_context ctx;
    cj4_yaku_decomposition decomp;
    cj4_yaku_flags flags = 0;
    ...
    cj4_win_yaku yaku)
{
    ...
    result->yaku[result->yaku_count++] = yaku;
}

static void
cj4_yaku_append_public_yakuman(
    cj4_win_result *result,
    cj4_yaku_flags flags)
{
    if (flags & CJ4_YAKU_KOKUSHI_13)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_KOKUSHI_13_WAIT);
    else if (flags & CJ4_YAKU_KOKUSHI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_KOKUSHI);

    if (flags & CJ4_YAKU_SUUANKOU_TANKI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SUUANKOU_TANKI);
    else if (flags & CJ4_YAKU_SUUANKOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SUUANKOU);

    if (flags & CJ4_YAKU_JUNSEI_CHUUREN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_JUNSEI_CHUUREN);
    else if (flags & CJ4_YAKU_CHUUREN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHUUREN);

    if (flags & (CJ4_YAKU_DAISUUSHII_DOUBLE | CJ4_YAKU_DAISUUSHII))
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_DAISUUSHII);

    if (flags & CJ4_YAKU_DAISANGEN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_DAISANGEN);
    if (flags & CJ4_YAKU_SHOUSUUSHII)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SHOUSUUSHII);
    if (flags & CJ4_YAKU_TSUUIISOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_TSUUIISOU);
    if (flags & CJ4_YAKU_RYUUIISOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_RYUUIISOU);
    if (flags & CJ4_YAKU_CHINROUTOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHINROUTOU);
    if (flags & CJ4_YAKU_SUUKANTSU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SUUKANTSU);
    if (flags & CJ4_YAKU_TENHOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_TENHOU);
    if (flags & CJ4_YAKU_CHIIHOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHIIHOU);
}

static void
cj4_yaku_append_public_standard(
    const cj4_mahjong *state,
    cj4_player player,
    const cj4_yaku_context *ctx,
    cj4_yaku_flags flags,
    cj4_win_result *result)
{
    ...
    if (flags & CJ4_YAKU_DOUBLE_RIICHI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_DOUBLE_RIICHI);
    else if (flags & CJ4_YAKU_RIICHI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_RIICHI);

    if (flags & CJ4_YAKU_IPPATSU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_IPPATSU);
    if (flags & CJ4_YAKU_MENZEN_TSUMO)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_MENZEN_TSUMO);
    if (flags & CJ4_YAKU_TANYAO)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_TANYAO);

    if (flags & CJ4_YAKU_YAKUHAI)
    {
        if (ctx->total_counts[CJ4_TILE_TYPE_HAKU] >= 3)
            cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_YAKUHAI_HAKU);
        if (ctx->total_counts[CJ4_TILE_TYPE_HATSU] >= 3)
            cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_YAKUHAI_HATSU);
        if (ctx->total_counts[CJ4_TILE_TYPE_CHUN] >= 3)
            cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_YAKUHAI_CHUN);
        if (ctx->total_counts[seat_type] >= 3)
            cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_YAKUHAI_SEAT_WIND);
        if (ctx->total_counts[round_type] >= 3)
            cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_YAKUHAI_ROUND_WIND);
    }

    if (flags & CJ4_YAKU_CHIITOI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHIITOI);
    if (flags & CJ4_YAKU_TOITOI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_TOITOI);
    if (flags & CJ4_YAKU_HONROUTOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_HONROUTOU);
    if (flags & CJ4_YAKU_HONITSU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_HONITSU);
    if (flags & CJ4_YAKU_CHINITSU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHINITSU);
    if (flags & CJ4_YAKU_PINFU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_PINFU);
    if (flags & CJ4_YAKU_IIPEIKOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_IIPEIKOU);
    if (flags & CJ4_YAKU_RYANPEIKOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_RYANPEIKOU);
    if (flags & CJ4_YAKU_SANSHOKU_DOUJUN)
    ...
    if (flags & CJ4_YAKU_SHOUSANGEN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SHOUSANGEN);
    if (flags & CJ4_YAKU_SANKANTSU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SANKANTSU);
    if (flags & CJ4_YAKU_SANSHOKU_DOUKOU)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_SANSHOKU_DOUKOU);
    if (flags & CJ4_YAKU_RINSHAN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_RINSHAN);
    if (flags & CJ4_YAKU_HAITEI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_HAITEI);
    if (flags & CJ4_YAKU_HOUTEI)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_HOUTEI);
    if (flags & CJ4_YAKU_CHANKAN)
        cj4_yaku_append_public_yaku(result, CJ4_WIN_YAKU_CHANKAN);
}

static uint8_t
cj4_yaku_build_win_result(
    const cj4_mahjong *state,
    cj4_player player,
    const cj4_rules *rules,
    cj4_win_result *out)
{
    ...
    if (!cj4_yaku_collect_best_result(&prepared, player, rules, &best))
        return 0;

    cj4_yaku_collect_context(&prepared, player, &ctx);

    out->player = player;
    out->han = best.score.han;
    out->fu = best.score.fu;
    out->yakuman_count = best.score.yakuman_count;
    out->ron_points = best.score.ron_points;
    out->tsumo_dealer_payment = best.score.tsumo_dealer_payment;
    out->tsumo_non_dealer_payment = best.score.tsumo_non_dealer_payment;
    cj4_yaku_copy_indicator_tiles(
        &prepared,
        0,
        out->dora_indicators,
        &out->dora_indicators_count);

    if (cj4_state_is_riichi(&prepared, player))
    {
        cj4_yaku_copy_indicator_tiles(
            &prepared,
            1,
            out->ura_dora_indicators,
            &out->ura_dora_indicators_count);
    }

    if (best.score.yakuman_count > 0)
    {
        cj4_yaku_append_public_yakuman(out, best.flags);
    }
    else
    {
        out->dora_count = cj4_yaku_count_indicator_dora(&prepared, &ctx, 0);
        out->aka_dora_count = cj4_yaku_count_aka_dora(&prepared, player, rules);
        out->ura_dora_count = cj4_state_is_riichi(&prepared, player)
                                  ? cj4_yaku_count_indicator_dora(&prepared, &ctx, 1)
                                  : 0;
        cj4_yaku_append_public_standard(&prepared, player, &ctx, best.flags, out);
    }
...
cj4_yaku_build_nagashi_result(
    ...
    cj4_win_result *out)
{
    if (!out || !cj4_is_nagashi_mangan(state, player))
        return 0;
    ...
    cj4_mahjong *prepared)
{
    ...
    *prepared = *state;
    prepared->locations[state->winning_tile].placement =
        cj4_location_make_hand(player);

    if (cj4_state_winner_count(state) == 1 &&
        cj4_get_winner(state, 0) == player &&
        cj4_state_current_player(state) == player &&
        state->draw_tile == state->winning_tile)
    {
        cj4_state_set_phase(prepared, CJ4_PHASE_DRAW);
        cj4_state_set_current_player(prepared, player);
    ...
    {
        cj4_state_set_phase(prepared, CJ4_PHASE_KAKAN_RESOLVE);
        cj4_state_set_current_player(prepared, cj4_state_current_player(state));
        cj4_state_set_chankan(prepared, 1);
    ...
    {
        cj4_state_set_phase(prepared, CJ4_PHASE_ANKAN_RESOLVE);
        cj4_state_set_current_player(prepared, cj4_state_current_player(state));
        cj4_state_set_chankan(prepared, 1);
    ...
    cj4_state_set_phase(prepared, CJ4_PHASE_DISCARD);
    cj4_state_set_current_player(prepared, cj4_state_current_player(state));
    prepared->draw_tile = CJ4_TILE_ID_INVALID;
    cj4_state_set_chankan(prepared, 0);
    ...
    uint8_t *out_count)
{
    ...
    *out_count = 0;
    ...
    if (winner_count == 0)
    {
        ...
        for (uint8_t player = 0; player < CJ4_PLAYER_COUNT; ++player)
        {
            if (rules && rules->nagashi_mangan &&
                ...
                cj4_is_nagashi_mangan(state, (cj4_player)player))
                nagashi_count++;
        }
        ...
        for (uint8_t player = 0; player < CJ4_PLAYER_COUNT; ++player)
        {
            if (!cj4_is_nagashi_mangan(state, (cj4_player)player))
                continue;
    ...
    if (!out_results || capacity < winner_count)
        return false;

    for (uint8_t i = 0; i < winner_count; ++i)
    {
        if (!cj4_yaku_build_win_result(
                state,
                cj4_get_winner(state, i),
                rules,
                &out_results[i]))
            return false;
    }

    *out_count = winner_count;
    return true;
}
